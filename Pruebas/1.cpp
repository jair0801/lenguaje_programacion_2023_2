...
void realizarVenta(Zapato& zapato) {
    ...
    if (cantidad > 0 && cantidad <= zapato.stock) {
        ...
        cout << "Venta realizada con éxito. Total a pagar: " << cantidad * zapato.precio << " $" << endl;
    } else {
        cout << "Error: Cantidad no válida o insuficiente en stock." << endl;
    }
}
...
int main() {
    ...
    zapatos[0] = {"Zapato1", "MarcaA", 50.00, 10};
    zapatos[1] = {"Zapato2", "MarcaB", 60.00, 8};
    zapatos[2] = {"Zapato3", "MarcaC", 40.00, 15};
